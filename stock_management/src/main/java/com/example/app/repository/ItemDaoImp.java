...
public class ItemDaoImp implements ItemDao {
	...
	public List<Item> findList(GetForm form) {
        ...
        sqlBuilder.append("SELECT d.id, d.category, d.title, d.content, DATE_FORMAT(d.date, '%Y/%m/%d') AS date, d.update_datetime, c.name "
        ...
        if(form.getDate() != null && form.getDate() != "") {
            sqlBuilder.append(" DATE_FORMAT(d.date, '%Y/%m/%d') = :date");
        ...
        for(Map<String, Object> result : resultList) {
            ...
            item.setTitle((String)result.get("title"));
            item.setContent((String)result.get("content"));
            item.setDate((String)result.get("date"));
            item.setUpdate_datetime((Timestamp)result.get("update_datetime"));
